    ...
    public ApplicationRunner preloadFlightData() {
        return args -> {
            ...
            if (!existingFlight2Optional.isPresent()) {
                Flight aa2011007202410 = new Flight(null, "AA201", aaAirline, bosAirport, lhrAirport, LocalDate.of(2024, 7, 10), LocalTime.of(10, 0), LocalTime.of(22, 0), 120, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightLY073.isPresent()) {
                Flight ly073 = new Flight(null, "LY073", lyAirline, tlvAirport, bomAirport, LocalDate.of(2024, 7, 1), LocalTime.of(16, 30), LocalTime.of(23, 45), 90, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightAF1234.isPresent()) {
                Flight af1234 = new Flight(null, "AF1234", afAirline, cdgAirport, athAirport, LocalDate.of(2024, 7, 4), LocalTime.of(16, 35), LocalTime.of(20, 50), 160, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightAI102.isPresent()) {
                Flight ai102 = new Flight(null, "AI102", aiAirline, jfkAirport, bomAirport, LocalDate.of(2024, 7, 2), LocalTime.of(22, 0), LocalTime.of(22, 30), 100, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightSN401.isPresent()) {
                Flight sn401 = new Flight(null, "SN401", snAirline, bruAirport, cdgAirport, LocalDate.of(2024, 8, 23), LocalTime.of(14, 30), LocalTime.of(16, 30), 190, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightIB456.isPresent()) {
                Flight ib456 = new Flight(null, "IB456", ibAirline, madAirport, fcoAirport, LocalDate.of(2024, 7, 29), LocalTime.of(14, 45), LocalTime.of(16, 30), 190, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightAZ324.isPresent()) {
                Flight az324 = new Flight(null, "AZ324", azAirline, fcoAirport, athAirport, LocalDate.of(2024, 7, 19), LocalTime.of(9, 30), LocalTime.of(13, 0), 160, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightKL201.isPresent()) {
                Flight kl201 = new Flight(null, "KL201", klAirline, amsAirport, fcoAirport, LocalDate.of(2024, 7, 26), LocalTime.of(10, 0), LocalTime.of(12, 30), 160, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightOS101.isPresent()) {
                Flight os10105072024 = new Flight(null, "OS101", osAirline, vieAirport, cdgAirport, LocalDate.of(2024, 7, 5), LocalTime.of(13, 0), LocalTime.of(16, 0), 170, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightLH100.isPresent()) {
                Flight lh10001072024 = new Flight(null, "LH100", lhAirline, mucAirport, jfkAirport, LocalDate.of(2024, 7, 1), LocalTime.of(10, 0), LocalTime.of(12, 30), 120, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightLX348.isPresent()) {
                Flight lx34805072024 = new Flight(null, "LX348", lxAirline, zrhAirport, lhrAirport, LocalDate.of(2024, 7, 5), LocalTime.of(9, 15), LocalTime.of(9, 55), 60, Flight.FlightStatus.SCHEDULED);
            ...
            if (!existingFlightA3.isPresent()) {
                Flight a3985 = new Flight(null, "A3985", a3Airline, athAirport, lhrAirport, LocalDate.of(2024, 7, 1), LocalTime.of(12, 0), LocalTime.of(14, 15), 120, Flight.FlightStatus.SCHEDULED);
